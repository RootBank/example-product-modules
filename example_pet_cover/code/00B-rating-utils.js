 ...
 * @param {Record<string, any>} pet object containing pets information
 ...
 * @param {Record<string, any>} pet The individual pet module data.
 ...
 * @param {Number} coverAmount The cover amount of the pet.
...
const getBasePremium = (coverAmount) => {
  ...
  // Find cover amount
  const basePremium = Object.values(basePremiumObject).find(
    (entry) => entry.cover_amount == coverAmount,
  );

  return basePremium ? basePremium.base_premium : 3386;
};
