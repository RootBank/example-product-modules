...
const applyAnnualIncrease = ({ policy }) => {
    ...
    const premium = yearsActive == policy.module.applied_anniversary_increases++ ? policy.monthly_premium * 1.05 : policy.monthly_premium;
    const appliedAnniversaryIncreases = yearsActive == policy.module.applied_anniversary_increases++ ? policy.module.applied_anniversary_increases++ : policy.monthly_premium;
